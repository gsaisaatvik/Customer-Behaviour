  ...
  const applyFilters = () => {
    const filtered = allCustomers.filter((customer) => {
      ...
      if (filters.riskCategory && filters.riskCategory !== "all") {
        ...
        if (customer.riskCategory !== category) return false;
      }
      return true;
    });
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Input name="bmiMin" value={filters.bmiMin} onChange={handleInputChange} placeholder="Min" type="number" />
                    <span>to</span>
                    <Input name="bmiMax" value={filters.bmiMax} onChange={handleInputChange} placeholder="Max" type="number" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Input name="riskScoreMin" value={filters.riskScoreMin} onChange={handleInputChange} placeholder="Min" type="number" />
                    <span>to</span>
                    <Input name="riskScoreMax" value={filters.riskScoreMax} onChange={handleInputChange} placeholder="Max" type="number" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select name="preExistingConditions" value={filters.preExistingConditions} onChange={handleInputChange} className="w-full h-10 border rounded px-2 mt-1">
                    <option value="">Any</option>
            ...
            <TableBody>
              {filteredCustomers.map((customer, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>
                    {customer.riskCategory === 0 ? "Low" : customer.riskCategory === 1 ? "Medium" : "High"}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
